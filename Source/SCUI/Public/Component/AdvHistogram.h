...
#include "AdvHistogram.generated.h"

class SAdvHistogram;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(FOnAdvHistogramHoverEvent, bool, bDataHovering, const FGraphDataColor&, Data, int32, DataIndex, const FGeometry&, MyGeometry, const FPointerEvent&, MouseEvent);

UCLASS()
class SCUI_API UAdvHistogram : public UGraphBase
{
...
public:
	...
	UPROPERTY(BlueprintAssignable, Category = "Widget Event")
		FOnAdvHistogramHoverEvent OnDataHover;
	...
	UFUNCTION(BlueprintCallable, Category = "Content")
		void SetDatas(const TArray<FGraphDataGroup>& InDatas);
...
private:
	TSharedPtr<SAdvHistogram> MyGraphWidget;
};